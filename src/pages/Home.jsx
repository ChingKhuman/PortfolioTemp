...
export default function Home() {
    ...
    return (
        <>
            <SplashSection splashMessage={'Chingtham Singh Web Developer'} isDarkMode={isDarkMode} isErrorMode={false} />
